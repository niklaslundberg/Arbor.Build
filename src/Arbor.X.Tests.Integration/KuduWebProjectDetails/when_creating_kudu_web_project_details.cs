...
namespace Arbor.X.Tests.Integration.KuduWebProjectDetails
{
    ...
    public class when_creating_kudu_web_project_details
    {
        ...
        Because of = () => { parsed = Core.Tools.Kudu.KuduWebProjectDetails.Create("<KuduWebJobName>MyWebJob</KuduWebJobName>", "<KuduWebJobType>Continuous</KuduWebJobType>", @"C:\Temp\test.csproj"); };
