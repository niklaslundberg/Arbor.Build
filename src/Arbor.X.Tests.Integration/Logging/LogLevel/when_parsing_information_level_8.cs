...
namespace Arbor.X.Tests.Integration.Logging.LogLevel
{
    ...
    public class when_parsing_information_level_8
    {
        ...
        private Because of = () => { logLevel = Core.Logging.LogLevel.TryParse(8); };

        private It should_equal_information_level = () => logLevel.Level.ShouldEqual(Core.Logging.LogLevel.Information.Level);
