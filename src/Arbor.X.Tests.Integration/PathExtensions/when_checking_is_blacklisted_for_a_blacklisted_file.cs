...
namespace Arbor.X.Tests.Integration.PathExtensions
{
    ...
    {
        private static readonly PathLookupSpecification path_lookup_specification = DefaultPaths.DefaultPathLookupSpecification.WithIgnoredFileNameParts(new [] {".vshost."});
