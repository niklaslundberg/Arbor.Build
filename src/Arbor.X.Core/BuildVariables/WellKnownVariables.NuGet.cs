namespace Arbor.X.Core.BuildVariables
{
    public static partial class WellKnownVariables
    {
        ...
        [VariableDescription("NuGet package id override")] public static readonly string NuGetPackageIdOverride =
        ...
        [VariableDescription(
            "Flag to indicate if created NuGet (binary+symbol) packages should be kept in the same folder", "true")]
        ...
        [VariableDescription("Flag to indicate if NuGet packages should be created regardless of the branch convention",
            "false")] public static readonly string NuGetCreatePackagesOnAnyBranchEnabled =
        ...
        [VariableDescription("Flag to indicate if NuGet packages should be created regardless of the branch convention",
            "false")] public static readonly string NuGetReinstallArborPackageEnabled =
        ...
        [VariableDescription("NuGet package upload URI")] public const string ExternalTools_NuGetServer_Uri =
