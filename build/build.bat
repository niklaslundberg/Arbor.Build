...
SET Arbor.X.Build.NetAssembly.Copyright=© Niklas Lundberg 2014-2019
...
REM SET Arbor.X.NuGet.NuGetWebPackage.ExcludedPatterns=roslyn\**\*.*
REM SET Arbor.X.Build.Tests.AssemblyStartsWith=Arbor.Build.Tests
